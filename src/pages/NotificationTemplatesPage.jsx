...
const NotificationTemplatesPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Quản Lý Mẫu Thông Báo - BVOTE WEB</title>
      </Helmet>
      <motion.div 
        ...
        <div className="p-4">
          <Card className="cyber-card-bg">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Tạo trước nội dung để gửi nhanh đến người dùng khi có cảnh báo.</CardDescription>
            </CardHeader>
