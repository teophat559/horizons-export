...
const OffLoginPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login OFF - Admin Dashboard</title>
      </Helmet>
      <motion.div 
      ...
      >
        <div className="p-4 border-b border-purple-500/30 flex items-center">
            ...
            <h2 className="text-center font-bold text-lg flex-1 text-white" style={{ textShadow: '0 0 8px rgba(138, 45, 226, 0.8)' }}>BẢNG ĐIỀU KHIỂN - LOGIN OFF</h2>
        </div>
