...
var BASE_PATH = process.env.VITE_BASE_PATH || (isAdminBuild ? "/admin/" : "/");
var OUT_DIR = process.env.VITE_OUT_DIR || (isAdminBuild ? "public/admin" : void 0);
